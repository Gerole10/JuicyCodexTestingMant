...
public class TarjetaDebito extends Tarjeta {
	...
	/**
	 *Constructor Clase TarjetaDebito.
	 *
	 */
	 ...
	 * ({@link edu.uclm.esi.iso2.banco20193capas.model.Cuenta#getSaldo() Cuenta.getSaldo()})
	 ...
	 * (ver {@link #confirmarCompraPorInternet(int)})
	 *  mediante el token que devuelve este método
	 * @param pin	El pin que introduce el usuario
	 ...
	 * @throws PinInvalidoException	Si el pin introducido
	 * es distinto del pin de la tarjeta
	 * @throws SaldoInsuficienteException
	 * Si el saldo de la cuenta asociada
	 * a la tarjeta es menor que el importe
	 * @throws ImporteInvalidoException
...
//		token =  1234;
	 ...
	 * Si el importe{@literal <}=0
	 * @throws SaldoInsuficienteException
	 * Si el saldo de lacuenta asociada ({@link Cuenta#getSaldo()})
	 * a la tarjeta es menor que el importe
	 * @throws TarjetaBloqueadaException
	 * Si la tarjeta está bloqueada
	...
	/**
	 * Permite cambiar pin.
	 * @param pinViejo	El pin anterior
